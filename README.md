...
--------------------------------------------------
-- TOGGLE SPEED PELO TECLADO (TECLA F) E DESATIVAR COM V
--------------------------------------------------
local SpeedToggleIndex = 1 -- 1 = SPEED 1 | 2 = SPEED 2
...
UserInputService.InputBegan:Connect(function(input, gpe)
    ...
    -- Tecla F: Alternar entre SPEED 1 e SPEED 2
    if input.KeyCode == Enum.KeyCode.F then
        -- Alternar índice
        SpeedToggleIndex = SpeedToggleIndex == 1 and 2 or 1
    ...
    -- Tecla V: DESATIVAR TODOS OS SPEEDS
    elseif input.KeyCode == Enum.KeyCode.V then
        SpeedEnabled = false
        SpeedEnabled2 = false
        
        -- Resetar o índice para 1 (opcional)
        SpeedToggleIndex = 1
        ...
        print("⛔ TODOS OS SPEEDS DESATIVADOS (TECLA V)")
